...
testhmc <- hmc(log_posterior = log_posterior, gradient = gradient, step_size=0.005, l=10, initP = c(-1.5, -2.5, -1, -3, 0), m = 500, Tlen = 200, N=2, states_primary = states, states_nghbors = list(states[[2]], states[[1]]))
